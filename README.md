...
This client uses the OAuth2/OIDC Authorization Code Flow + PKCE to obtain an access token. See the authentication [README](../../../README.md) for more information about this flow.
